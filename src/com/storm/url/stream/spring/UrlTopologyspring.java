...
public class UrlTopologyspring {
	...
	private IRichSpout spout_class;
	private IRichBolt bolt_class;
	...
	public void buildTopology(String spoutName, String boltName) 
	{
		...
		/*urlspout= (SpringUrlSpout) Util.initializeContext("UrlSpout");
		urlbolt = (SpringUrlBolt) Util.initializeContext("UrlBolt");
		...
		*/
		...
		urlspout= (SpringUrlSpout) Util.intializeSpringUrlSpoutBean("UrlSpout");
		urlspout.setSpoutName(spoutName);
		urlbolt = (SpringUrlBolt) Util.intializeSpringUrlBoltBean("UrlBolt");
